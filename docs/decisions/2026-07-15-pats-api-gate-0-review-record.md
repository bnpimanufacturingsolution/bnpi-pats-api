...
| D-008 station granularity | `WORKING DEFAULT` (2026-08-10) | Station = device at Stage/SubStage (default SubStage); Process not a PC; Booth separate | Product owner session + app decision report | `ADOPTED_WORKING_DEFAULT` |
