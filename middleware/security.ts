...
import { rateLimiter, authRateLimiter, slowDownMiddleware } from "./rateLimiter";
...
// Authentication-specific security (stricter rate limiting)
export const authSecurityMiddleware = [authRateLimiter];
